              ...
              <div className="row">
                 <div className="col-md-6">
                    <div className="section-title">
                       <h2 className="contactTitles">Get In Touch</h2>
                    </div>
                 ...
                 <div className="col-md-6">
                    ...
                    <p className="contactText">After booking your experience , you will receive an email from our team with the order invoice and booking details</p>
